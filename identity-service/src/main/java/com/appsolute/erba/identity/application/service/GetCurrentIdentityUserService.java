...
@Service
public class GetCurrentIdentityUserService {

    private final IdentityUserRepository identityUserRepository;
    private final EmployeeProfileRepository employeeProfileRepository;

    public GetCurrentIdentityUserService(
    ...
    public GetIdentityUserResult getCurrent(UUID authUserId) {
        IdentityUser identityUser = identityUserRepository.findByAuthUserId(authUserId)
